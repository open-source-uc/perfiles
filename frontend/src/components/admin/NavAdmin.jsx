...
function AdminSidebar() {
  return (
    <aside className="z-0 fixed h-screen p-4 space-y-1 min-h-full items-center top-30 left-0 w-16  flex flex-col shadow-lg bg-white dark:bg-gray-900" aria-label="Navegación de Admin">
