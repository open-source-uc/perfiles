...
export default function ProfileCard({ name, title, username }) {
  ...
  return (
    ...
    >
      <motion.div
        className="flex flex-col p-1 items-center justify-center h-[200px] w-[175px] shadow-xl bg-neutral-100 dark:bg-slate-200 rounded-xl cursor-pointer"
      ...
      >
        ...
        <p className="text-center break-words w-[180px] text-slate-700 text-xs">{title}</p>
      </motion.div>
    </motion.div>
  );
}
